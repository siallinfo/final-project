            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                    <div class="about__img">
                        <img src="{{asset('/')}}website/assets/img/about/about__1.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="video__img">
                        <img src="{{asset('/')}}website/assets/img/about/video-banner__1.jpg" alt="">
            ...
            <div class="brand__wraper brand__slider__active">
                <div class="brand__single">
                    <div class="brand__img">
                        <img src="{{asset('/')}}website/assets/img/brand/brand-logo-1.png" alt="">
                    </div>
                </div>

                <div class="brand__single">
                    <div class="brand__img">
                        <img src="{{asset('/')}}website/assets/img/brand/brand-logo-2.png" alt="">
                    </div>
                </div>

                <div class="brand__single">
                    <div class="brand__img">
                        <img src="{{asset('/')}}website/assets/img/brand/brand-logo-3.png" alt="">
                    </div>
                </div>

                <div class="brand__single">
                    <div class="brand__img">
                        <img src="{{asset('/')}}website/assets/img/brand/brand-logo-4.png" alt="">
                    </div>
                </div>

                <div class="brand__single">
                    <div class="brand__img">
                        <img src="{{asset('/')}}website/assets/img/brand/brand-logo-5.png" alt="">
                    </div>
                </div>

                <div class="brand__single">
                    <div class="brand__img">
                        <img src="{{asset('/')}}website/assets/img/brand/brand-logo-6.png" alt="">
                    </div>
                </div>

                <div class="brand__single">
                    <div class="brand__img">
                        <img src="{{asset('/')}}website/assets/img/brand/brand-logo-7.png" alt="">
                    </div>
                </div>
            </div>
        </div>
