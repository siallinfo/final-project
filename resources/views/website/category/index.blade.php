            ...
            <div class="row grid__responsive">
                            ...
                            <div class="sidebar__menu">
                                ...
                                <ul>
                                    @foreach($categories as $category)
                                        <li>
                                            <a href="#">{{$category->name}} <span>({{ count($category->products) }})</span></a>
                ...
                <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12">
                    ...
                    <div class="pagination__wraper text-center sp_top_40">
                        <ul>
                            <li class="{{ $products->onFirstPage() ? 'disabled' : 'prev' }}">
                            ...
                            @foreach ($products->links()->elements[0] as $page => $url)
                                <li class="{{ $products->currentPage() == $page ? 'active' : '' }}">
                                    <a href="{{ $url }}" title="Page {{ $page }}">{{ $page }}</a>
                                </li>
                            @endforeach

                            <li class="{{ $products->hasMorePages() ? 'next' : 'disabled' }}">
