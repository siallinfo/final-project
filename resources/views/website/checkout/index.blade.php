            ...
            <div class="row">
                <div class="col-xl-8 offset-md-2 loginarea__col">
                    <ul class="nav  tab__button__wrap text-center" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="single__tab__link" data-bs-toggle="tab" data-bs-target="#projects__two" type="button">Registration</button>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-content tab__content__wrapper" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="projects__two" role="tabpanel" aria-labelledby="projects__two">
                        <div class="col-xl-8 offset-md-2 loginarea__col">
                            <div class="loginarea__wraper">
                                <div class="loginarea__heading">
                                    <h5 class="login__title">Register Here</h5>
                                ...
                                <form action="{{route('checkout.new-customer')}}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="loginarea__form">
                                                ...
                                                <input class="common__login__input" type="text" name="name" placeholder="Full Name">
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="loginarea__form">
                                                <label class="form__label">Email Address</label>
                                                <input class="common__login__input" type="email" name="email" placeholder="Email Address">
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="loginarea__form">
                                                <label class="form__label">Phone Number</label>
                                                <input class="common__login__input" type="number" name="mobile" placeholder="Your Phone Number">
                                    ...
                                    <div class="login__button">
                                        <button type="submit" class="default__button text-center w-100">Register</button>
                                    </div>
                                </form>
                            </div>
                        </div>
