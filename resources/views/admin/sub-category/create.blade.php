                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{route('sub-category.index')}}" class="btn btn-sm btn-success">
                                ...
                                <div class="general-label">
                                    <form action="{{route('sub-category.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="name" id="horizontalInput1" placeholder="Enter Sub-Category Name">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10 ms-auto">
                                                <button type="submit" class="btn btn-de-primary">Add New Sub-Category</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
