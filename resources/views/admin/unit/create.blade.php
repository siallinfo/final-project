                                ...
                                <div class="general-label">
                                    <form action="{{route('unit.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="name" id="horizontalInput1" placeholder="Enter Unit Name">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10 ms-auto">
                                                <button type="submit" class="btn btn-de-primary">Add New Unit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
